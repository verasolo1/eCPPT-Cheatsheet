...
- [Client-Side Attacks](#client-side-attacks)
  ...
  - [Other Client-Side Attacks](#other-client-side-attacks)
- [Framework](#framework)
- [Web App PT](#web-app-pt)
  - [Passive info gathering](#passive-info-gathering)
    - [NetsCraft](#netscraft)
    - [dnsrecon x dnsdumpster](#dnsrecon-x-dnsdumpster)
...
- [Privilege Escalation](#privilege-escalation)
  - [Scripts (Migrate to more stable process before scrip...)](#scripts-migrate-to-more-stable-process-before-scrip)
...
- [Basic Process of PowerShell Empire CLI...](#basic-process-of-powershell-empire-cli)
